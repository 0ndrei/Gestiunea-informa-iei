...
/*CREATE TABLE student (
	...
	, BURSA SMALLINT NOT NULL
	, ANUL TINYINT UNSIGNED NOT NULL
	, ORAS VARCHAR(20) 
	, DATA_N DATE 
	, UNIV_ID TINYINT UNSIGNED NOT NULL
);
...
CREATE TABLE CURS (
	CURS_ID SMALLINT PRIMARY KEY
	, CURS_DEN VARCHAR(20) NOT NULL
	, ORE TINYINT UNSIGNED NOT NULL
	, SEMESTRU TINYINT UNSIGNED NOT NULL
); 

CREATE TABLE UNIVERSITATE (
	UNIV_ID SMALLINT PRIMARY KEY
	, UNIV_DEN VARCHAR(20) NOT NULL
	, RATING SMALLINT NOT NULL
	, ORAS VARCHAR(20) NOT NULL
); 

CREATE TABLE NOTE_EXAM (
	EXAM_ID SMALLINT PRIMARY KEY
	, ST_ID SMALLINT NOT NULL
	, CURS_ID SMALLINT NOT NULL
...
-- ALTER TABLE student ADD FOREIGN KEY (UNIV_ID) REFERENCES universitate(UNIV_ID);

/*INSERT INTO student
VALUES (1, 'Popescu', 'Ion', 150, 1, 'Orhei', '1982-12-03', 10); 

INSERT INTO student
VALUES (3, 'Ionescu', 'Petru', 200, 3, 'Cahul', '1980-12-01', 10);

INSERT INTO student
VALUES (6, 'Sima', 'Vadim', 150, 4, 'Chisinau', '1979-06-07', 22);

INSERT INTO student
VALUES (10, 'Osman', 'Nicolai', 0, 2, 'Briceni', '1981-12-08', 10);

INSERT INTO student
VALUES (12, 'Casta', 'Olga', 250, 2, 'Lipcani', '1981-05-01', 10);

INSERT INTO student
VALUES (265, 'Mantes', 'Andrei', 0, 3, 'Balti', '1979-11-05', 10);

INSERT INTO student
VALUES (32, 'Colesnic', 'Petru', 150, 5, 'Drochia', NULL, 14);

INSERT INTO student
VALUES (654, 'Luca', 'Artur', 200, 3, 'Balti', '1981-12-01', 10);

INSERT INTO student
VALUES (276, 'Petrescu', 'Elena', 200, 4, NULL, '1981-08-05', 22);

INSERT INTO student
VALUES (55, 'Banescu', 'Vald', 250, 5, 'Balti', '1980-01-07', 10); */


/*INSERT INTO profesor
VALUES (24, 'Iordachi', 'Boris', 'Balti', 10); 

INSERT INTO profesor
VALUES (46, 'Nuca', 'Ion', 'Balti', 10);

INSERT INTO profesor
VALUES (74, 'Lasescu', 'Pavel', 'Chisinau', 22);

INSERT INTO profesor
VALUES (108, 'Stanescu', 'Nicolai', 'Chisinau', 22);

INSERT INTO profesor
VALUES (276, 'Negrescu', 'Victor', 'Balti', 10);

INSERT INTO profesor
VALUES (328, 'Sorescu', 'Andrei', 'Orhei', 10); */


/*INSERT INTO curs
VALUES (10, 'Informatica', 56, 1); 

INSERT INTO curs
VALUES (22, 'Fizica', 34, 1);

INSERT INTO curs
VALUES (43, 'Matematica', 56, 2);

INSERT INTO curs
VALUES (56, 'Istoria', 34, 4);

INSERT INTO curs
VALUES (94, 'Limba Engleza', 56, 3);

INSERT INTO curs
VALUES (73, 'Educatia fizica', 34, 5); */


/*INSERT INTO universitate
VALUES (22, 'USM', 606, 'Chisinau'); 

INSERT INTO universitate
VALUES (10, 'USB', 296, 'Balti');

INSERT INTO universitate
VALUES (11, 'ULIM', 345, 'Chisinau');

INSERT INTO universitate
VALUES (32, 'USC', 416, 'Cahul');

INSERT INTO universitate
VALUES (14, 'USD', 326, 'Drochia');

INSERT INTO universitate
VALUES (15, 'USC', 368, 'Chisinau');

INSERT INTO universitate
VALUES (18, 'ВГМА', 327, 'Balti'); */


/*INSERT INTO note_exam
VALUES (145, 12, 10, 10, '2000-01-12'); 

INSERT INTO note_exam
VALUES (34, 32, 10, 9, '2000-01-23');

INSERT INTO note_exam
VALUES (75, 55, 10, 9, '2000-01-05');

INSERT INTO note_exam
VALUES (238, 12, 22, 6, '1999-06-17'); 

INSERT INTO note_exam
VALUES (639, 55, 22, NULL, '1999-06-22');

INSERT INTO note_exam
VALUES (43, 6, 22, 5, '2000-01-18'); */


/*INSERT INTO curs_prof
VALUES (24, 24);
...
-- Ex 54. 
/* Sa se formuleze o interogare care ar afisa numarul de cursuri 
la care a fost examinati studenti ce au sustinut mai mult de 20 de examene. */
...
/*SELECT ST_ID, NUME, ORAS, BURSA FROM 
	(SELECT NUME, ST_ID, ORAS, BURSA FROM STUDENT) AS T1 INNER JOIN 
	(SELECT ORAS AS ORAS1, MAX(BURSA) AS BURSA1 
		FROM STUDENT WHERE ORAS IS NOT NULL 
			GROUP BY ORAS) AS T2 
				ON ORAS = ORAS1 AND BURSA = BURSA1; */

-- Ex 56.
/* Sa se formuleze o interogare care ar afisa numele si 
identificatorul studentilor care locuiesc in oraş 
in care nu este universitate. */
/*SELECT ST_ID, NUME, PRENUME, ORAS
FROM student AS s
...
/*SELECT ST_ID, NUME, PRENUME, student.ORAS 
...
/*SELECT *
FROM student
WHERE student.oras IN (SELECT DISTINCT ORAS FROM universitate) AND 
	student.oras != (SELECT ORAS FROM universitate WHERE UNIV_ID = student.UNIV_ID); */
...
/*SELECT DISTINCT student.ST_ID, NUME
FROM student INNER JOIN note_exam
ON student.ST_ID = note_exam.ST_ID
WHERE NOTA > (SELECT NOTA FROM note_exam WHERE DATA_EXAM = '1999-06-17'); */
/*SELECT DISTINCT ST_ID FROM NOTE_EXAM 
WHERE NOTA > (SELECT MIN(NOTA) FROM NOTE_EXAM 
...
/*SELECT DISTINCT STUDENT.*, 
				CASE WHEN NOTA >= 5 THEN CURS_ID ELSE NULL END AS CURS_ID 
				FROM STUDENT 
				LEFT JOIN NOTE_EXAM ON STUDENT.ST_ID = NOTE_EXAM.ST_ID; */
...
/*SELECT
    ...
    MAX(BURSA)
FROM UNIVERSITATE
    LEFT JOIN STUDENT USING (UNIV_ID)
WHERE RATING > 300
GROUP BY UNIV_DEN; */
...
FROM student LEFT JOIN universitate 
ON student.UNIV_ID = universitate.UNIV_ID 
...
-- Ex 78.
/* Sa se formulze o interogare care ar afisa toate perechile de nume a studentilor care locuiesc in acelasi oras, cu exceptia combinatiei numelui studentilor cu ei insesi (Popescu – Popescu) si a combinatiilor 
ce difera după ordinea numelor (Popescu – Ionescu sau Ionescu – Popescu). */
/*SELECT T1.ORAS, T1.NUME AS NUME1, T2.NUME AS NUME2 
FROM STUDENT AS T1 
INNER JOIN STUDENT AS T2 ON T1.ORAS = T2.ORAS AND T1.NUME != T2.NUME; */

-- Ex 79.
/* Sa se formulze o interogare care ar afisa lista tuturor perechilor de denumiri de universitati care se afla in acelasi oras. */
/*SELECT a.UNIV_DEN, a.ORAS, b.UNIV_DEN, b.ORAS
FROM universitate a INNER JOIN universitate b
ON a.ORAS = b.ORAS AND a.UNIV_DEN <> b.UNIV_DEN
ORDER BY a.ORAS; */

-- Ex 80.
/* Sa se formuleze o interogare care permite vizualizarea denumirii universitatilor si oraselor unde se afla aceste universitati pentru care reitingul este egal sau depaseste reitingul univesitatii din Balti. */
/*SELECT UNIV_DEN, ORAS, RATING 
FROM universitate 
WHERE RATING >= (SELECT MAX(RATING) FROM universitate WHERE ORAS='Balti'); */

-- Ex 81.
/* Sa înscrie instructiunea care ar adauga in tabela CURS o noua inregistrare pentru un curs nou cu urmatoarele valori pentru campuri: semestrul – 4; denumirea – Algebra; numarul de ore – 72; identificatorul – 201. */
/*INSERT INTO curs
VALUES (201, 'Algebra', 72, 4); */

-- Ex 82.
/* Sa se adauge o inregistrare pentru un student nou pe care il cheamă Osman Nicolai, care isi face studiile la USB în anul I de studii si care locuieşte in orasul Balti, iar date despre data de nastere si bursa nu se cunosc. */
/*INSERT INTO student
VALUES (11, 'Osman', 'Nicolai', 0, 1, 'Balti', NULL, 10); */

-- Ex 83.
/* Sa se inscrie o instructiune pentru a elimina din tabela NOTE_EXAM toate inregistrarile in care se pastreaza notele studentului cu numarul de identificare egal cu 100. */
/*DELETE 
FROM note_exam
WHERE ST_ID=100; */

-- Ex 84.
/* Sa se inscrie o instructiune care ar mari reitingul universitatilor din Cahul cu 5. */
/*UPDATE universitate
SET RATING=RATING+5
WHERE ORAS='Cahul'; */

-- Ex 85.
/* Sa se inscrie o instructiune care ar fi necesara in caz ca Popescu se muta cu traiul in Balti. */
/*UPDATE student
SET ORAS='Balti'
WHERE NUME='Popescu'; */

-- Ex 86.
/* Sa se inscrie o instructiune care ar adauga in tabelul STUDENTI (tabelul STUDENTI are aceeasi structura ca si STUDENT) datele 
...
-- Ex 87.
/* Sa se inscrie o instructiune care ar adauga in tabelul STUDENTI (tabelul STUDENTI are aceeasi structura ca si STUDENT) datele despre 
...
-- Ex 88.
/* Sa se înscrie o instructiune care ar elimina din tabelul CURS acele cursuri la care nici un student nu a obtinut nici o nota. */
/*DELETE FROM CURS WHERE CURS_ID 
NOT IN (SELECT DISTINCT CURS_ID 
FROM NOTE_EXAM WHERE NOTA IS NOT NULL); */

-- Ex 89.
/* Sa se inscrie o instructiune care ar permite marirea bursei cu 20% pentru acei studenti care au o suma a notelor ce depaseste 50 puncte. */
...
-- Ex 90.
/* Sa se inscrie o instructiune CREATE TABLE pentru crearea tabelului PROFESOR. */
/*CREATE TABLE PROFESOR (
	PR_ID SMALLINT PRIMARY KEY
	, NUME VARCHAR(30) NOT NULL
	, PRENUME VARCHAR(20) NOT NULL
...
-- Ex 91.
/* Sa se inscrie o instructiune CREATE TABLE pentru crearea tabelului CURS. */
/*CREATE TABLE CURS (
	CURS_ID SMALLINT PRIMARY KEY
	, CURS_DEN VARCHAR(20) NOT NULL
	, ORE TINYINT UNSIGNED NOT NULL
...
-- Ex 92.
/* Sa se inscrie o instructiune CREATE TABLE pentru crearea tabelului UNIVERSITATE. */
/*CREATE TABLE UNIVERSITATE (
	UNIV_ID SMALLINT PRIMARY KEY
	, UNIV_DEN VARCHAR(20) NOT NULL
	, RATING SMALLINT NOT NULL
...
-- Ex 93.
/* Sa se inscrie o instructiune CREATE TABLE pentru crearea tabelului NOTE_EXAM. */
/*CREATE TABLE NOTE_EXAM (
	EXAM_ID SMALLINT PRIMARY KEY
	, ST_ID SMALLINT NOT NULL
	, CURS_ID SMALLINT NOT NULL
...
-- Ex 94.
/* Sa se inscrie o instructiune CREATE TABLE pentru crearea tabelului CURS_PROF. */
/*CREATE TABLE CURS_PROF (
	PR_ID SMALLINT PRIMARY KEY
	, CURS_ID SMALLINT NOT NULL
); */
...
-- Ex 95.
/* Sa se inscrie o instructiune care ar mari viteza de selectare a datelor despre studenti dupa anul de studii. */
-- CREATE INDEX studentii ON student(ANUL);
-- DROP INDEX studentii ON student
/*EXPLAIN SELECT *
FROM student
ORDER BY ANUL; */
...
-- Ex 96.
/* Sa se defineasca un index care ar permite pentru fiecare student mai repede de regasit notele obtinute de el grupate după data examinarii. */
